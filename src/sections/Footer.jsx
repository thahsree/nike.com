                ...
                <div className='flex flex-col items-start'>
                    ...
                    <div className='flex items-center gap-5 mt-8'>
                        {socialMedia.map((icon,i)=>(
                            <div className='flex justify-center items-center w-12 h-12 bg-white rounded-full' key={i}>
                            ...
                            <div key={i}>
                                ...
                                <ul>
                                    {section.links.map((link,i)=>(
                                        <li className='mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer' key={i}><a href="">{link.name}</a></li>
                                    ))}
                                </ul>
                            </div>
                        ))}
