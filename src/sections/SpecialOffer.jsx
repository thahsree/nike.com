        ...
        <section className='flex justify-wrap justify-center items-center max-xl:flex-col-reverse gap-10 max-container'>
            ...
            <div className='flex flex-1 flex-col'>
                ...
                <p className='mt-4 lg:max-w-lg info-text'>
                    Embark on a shopping journey that redifines your experience with unbeatable deals. Form premier selections
                    to incredible savings, we offer unparalleled value that sets us apart.
                </p>
                <p className='mt-6 lg:max-w-lg info-text'>
                    Navigate a realm of possibilities designed to fulfill your unique desires, surpassing the loftiest expectations. Your journey 
